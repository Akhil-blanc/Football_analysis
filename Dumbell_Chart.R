...
league_table <- fb_season_team_stats(country = "FRA", gender = "M", season_end_year = "2021", tier = "1st", stat_type = "league_table_home_away")
...
ggsave("Dumbell Chart.png", width = 10, height = 10, units = "in", dpi = 300)
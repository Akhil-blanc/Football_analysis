...
# Scraping data
data1 <- fb_season_team_stats(country = "ENG", gender = "M", season_end_year = "2021", tier = "1st", stat_type = "defense")
...
rename(fint = "Att 3rd_Tackles") %>%
rename("Succ1" = "Tkl_percent_Challenges") %>%
...
rename(fint = "Att 3rd_Tackles") %>%
rename("Succ2" = "Tkl_percent_Challenges") %>%
